...
void displayFurniture(Furniture furniture[], int totalFurniture){
   ...
   /// Bubble Sort the array
    for (int i = 1; i < totalFurniture; i++){
        for (int j = 0; j < totalFurniture - i; j++){
            if (furnitureIsBefore(furniture[j], furniture[j+1]) == 1)
                furniture[j].swapFurniture(furniture[j+1]);
        }
    }
...
void displayFabric(Fabric fabric[], int totalFabric){
    ...
    /// Bubble Sort the array
    for (int i = 1; i < totalFabric; i++){
        for (int j = 0; j < totalFabric - i; j++){
            if (fabric[j].fabricIsBefore(fabric[j+1]) == 1)
                fabric[j].swapFabric(fabric[j+1]);
        }
    }
...
void displayArt(Art art[], int totalArt){
   ...
   /// Bubble Sort the array
    for (int i = 1; i < totalArt; i++){
        for (int j = 0; j < totalArt - i; j++){
            if (art[j].artIsBefore(art[j+1]) == 1)
                art[j].swapArt(art[j+1]);
        }
    }
...
void displayBook(Book book[], int totalBook){
   ...
   /// Bubble Sort the array
    for (int i = 1; i < totalBook; i++){
        for (int j = 0; j < totalBook - i; j++){
            if (book[j].bookIsBefore(book[j+1]) == 1)
                book[j].swapBook(book[j+1]);
        }
    }
